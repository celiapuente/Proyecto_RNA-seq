...
indir <- "/mnt/atgc-d1/bioinfoII/rnaseq/BioProject_2025/Equipo3/STAR_output"
outdir <- "/mnt/atgc-d1/bioinfoII/rnaseq/BioProject_2025/Equipo3/results"
...
# Cargar Metadatos
metadata <- read.csv("/mnt/atgc-d1/bioinfoII/rnaseq/BioProject_2025/Equipo3/metadata.csv", header = F)
